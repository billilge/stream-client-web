...
export type LockersZoneStatus = "spacious" | "normal" | "almostFull" | "full";

export interface LockersZone {
  id: string;
  name: string;
  status: LockersZoneStatus;
  remaining: number;
  total: number;
}
...
export const LOCKERS_LEFT_ZONES: LockersZone[] = [
  { id: "A-1", name: "A-1", remaining: 24, status: "spacious", total: 34 },
];

export const LOCKERS_RIGHT_ZONES: LockersZone[] = [
...
export const LOCKERS_RIGHT_ZONES_BELOW_STAIRS: LockersZone[] = [
